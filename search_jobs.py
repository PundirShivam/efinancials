...
while True:
	...
	#url = 'https://job-search-api.efinancialcareers.com/v1/efc/jobs/search?location=ASIA&EUROPE&GULF&countryCode2=GB&page={}&pageSize=200'.format(pg)
...
jobs_df.to_excel(f'London-Jobs_asof_{datetime.now().date().strftime("%Y-%m-%d")}.xlsx')